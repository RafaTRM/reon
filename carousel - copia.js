...
nav.addEventListener("click", function(e){
    ...
    const currentDot = nav.querySelectorAll(".active");


    //select the current slide
    const currentSlide = carousel.querySelectorAll(".active");
    ...
    moveToSlide(carousel, currentSlide, targetSlide);   
    toogleActive(currentDot, targetDot);
...
function moveToSlide(carousel, currentSlide, targetSlide){
    ...
    toogleActive(currentSlide, targetSlide);
}

//toogle active class
function toogleActive(current, target){
